...
const ActionButton = styled(Button)`
  ...
  padding-left: 15px;
  border-radius: 4px;
  border: 1px solid rgb(117 206 220);
`;
  ...
  return (
    <FloatingElement style={{ flex: 1, paddingTop: 9 }}>
          ...
          ([currency, balances, baseOrQuote, mint], index) => (
            <React.Fragment key={index}>
              <Row style={{
                ...
                <Col span={6} style={{ color: 'rgb(117 206 220)', textAlign: 'left' }}>
                  {currency}
                </Col>
                <Col span={9}>
      ...
      <div style={{ textAlign: 'center', paddingTop: 32, display: window.innerWidth>540 ? 'block':'none' }}>
        ...
        >
        <div style={{ paddingTop: 16, fontSize: 12, color: '#26a69a' }}>

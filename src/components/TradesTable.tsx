...
export default function PublicTrades({ smallScreen }) {
  ...
  return (
    ...
    >
      <Title
        style={{
          color: 'rgb(117 206 220)',
          fontSize: 14,
          borderBottom: '1px solid #4c3498',
          padding: '12px 0 12px 16px',
        }}
      >Recent Market trades</Title>
      <SizeTitle>
        <Col span={8} style={{ textAlign: 'left', paddingRight: 20, color: 'rgb(117 206 220)', fontSize: 12 }}>Price ({quoteCurrency}) </Col>
        <Col span={8} style={{ textAlign: 'right', paddingRight: 20, color: 'rgb(117 206 220)', fontSize: 12 }}>
          Size ({baseCurrency})
        </Col>
        <Col span={8} style={{ textAlign: 'right', paddingRight: 20, color: 'rgb(117 206 220)', fontSize: 12 }}>
          Time

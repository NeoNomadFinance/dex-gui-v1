      ...
      <div style={{ flex: 1 }}>
        <Row>
          <Col
            ...
            style={{
              ...
              textAlign: 'center',
              border: 'transparent',
              borderBottom: side === 'buy' ? '2px solid #26a69a' : '2px solid #6d57ad',
              background: 'transparent',
              fontSize: 14,
              fontStyle: 'normal',
              fontWeight: 600,
              color: side === 'buy' ? '#F1F1F2' : 'rgb(117 206 220)',
              padding: '12px 0 0 0'
            }}
          >
            BUY
          ...
          <Col
            ...
            style={{
              ...
              textAlign: 'center',
              border: 'transparent',
              borderBottom: side === 'sell' ? '2px solid #26a69a' : '2px solid #6d57ad',
              background: 'transparent',
              fontSize: 14,
              fontStyle: 'normal',
              fontWeight: 600,
              color: side === 'sell' ? '#F1F1F2' : 'rgb(117 206 220)',
              padding: '12px 0 0 0'
            }}
          >
            SELL
        ...
        >
          ...
          <div style={{ marginTop: 25}}>
            <div style={{ textAlign: 'right', paddingBottom: 8, fontSize: 12, color: '#46c0dc', }}>Limit price</div>
            <Input
              type="number"
              bordered={false}
              style={{ textAlign: 'right', paddingBottom: 8, height: 47, background: '#6d57ad', borderRadius: 4, }}
              suffix={
          ...
          <div style={{ marginTop: 25}}>
            <div style={{ textAlign: 'right', paddingBottom: 8, fontSize: 12, color: '#46c0dc', }}>Amount</div>
            <Input
              type="number"
              bordered={false}
              style={{ textAlign: 'right', paddingBottom: 8, height: 47, background: '#6d57ad', borderRadius: 4, }}
          ...
          <div style={{ marginTop: 25}}>
            <div style={{ textAlign: 'right', paddingBottom: 8, fontSize: 12,color: '#46c0dc', }}>Total</div>
            <Input
              type="number"
              bordered={false}
              style={{ textAlign: 'right', paddingBottom: 8, height: 47, background: '#6d57ad', borderRadius: 4, }}
